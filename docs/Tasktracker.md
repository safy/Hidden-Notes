...
> **Последнее обновление**: 2025-10-30 (Багфикс скрытия нескольких изображений)  
> **Текущая фаза**: Phase 5 - Polish & Testing | Защита данных реализована  
> **Общий прогресс**: ~86% (43/50 задач завершено)
...
| Phase 4: Storage & Notes | 🟢 Завершена | 10/10 | 10 | Критический |
...
> 2025-10-30 — Багфикс (Phase 3/UI): Исправлено контекстное меню скрытия изображений — теперь корректно работает для каждого изображения по месту клика (используется `posAtCoords`).
...
- **Статус**: 🟢 Завершена
- **Приоритет**: Высокий
- **Завершено**: 2025-10-17 (обновлено 2025-01-XX)
- **Описание**: Полная поддержка изображений с drag & drop, resizing и загрузкой из файловой системы
...
- [x] Добавить кнопку загрузки изображений из файловой системы
...
- ✅ Загрузка изображений через кнопку в toolbar (file input)
...
- ✅ File input для загрузки изображений с компьютера
...
### Задача 2.11: DragHandleReact

- **Статус**: 🟢 Завершена
- **Приоритет**: Высокий
- **Завершено**: 2025-10-19
- **Описание**: Интеграция DragHandleReact для перетаскивания изображений

**Шаги выполнения**:
- [x] Установить @tiptap/react-node-view-plugin
- [x] Создать компонент DragHandle.tsx
- [x] Интегрировать в TiptapEditor
- [x] Добавить обработчик событий для drag & drop

**Зависимости**: Задача 2.6

**Критерии приемки**:
- ✅ Drag & drop изображений работает
- ✅ DragHandle корректно отображается
- ✅ Нет ошибок в консоли

---

## Phase 3: Hidden Text Feature ✅ ЗАВЕРШЕНА

**Цель фазы**: Реализовать уникальную функцию визуального скрытия конфиденциального текста.
**Завершено**: 7/7 задач (100%)
...
**Шаги выполнения**:
- [x] Реализовать debounced save (1000ms)
- [x] Добавить индикатор "Saving..." / "Saved" / "Error"
- [x] Обработка ошибок сохранения
- [x] Предотвращение потери данных при закрытии
- [x] Cleanup timeouts при unmount
...
**Шаги выполнения**:
- [x] Создать editable title field в header редактора
- [x] Реализовать inline editing
- [x] Auto-save при blur
- [x] Валидация (не пустое название)
- [x] Fallback на "Без названия"
- [x] Горячие клавиши (Enter/Escape)
...
**Шаги выполнения**:
- [x] Добавить функцию exportNotes() в storage.ts
- [x] Сериализовать все заметки в JSON
- [x] Скачать как файл с timestamp
- [x] Добавить горячую клавишу Ctrl+E
- [x] Добавить в Settings button подсказку
- [x] Error handling
...
- ✅ Файл скачивается с timestamp: `hidden-notes-backup-YYYY-MM-DDThh-mm-ss.json`
- ✅ Все заметки включены в экспорт
- ✅ Ctrl+E работает из любого места
...
**Шаги выполнения**:
- [x] Создать Settings page/dialog
- [x] Добавить настройку темы (перенесено из header)
- [ ] Добавить настройку размера шрифта
- [ ] Добавить настройку auto-save interval
- [x] Добавить About секцию (версия, автор)
